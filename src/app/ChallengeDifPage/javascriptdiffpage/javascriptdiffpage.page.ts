...
@Component({
  selector: 'app-javascriptdiffpage',
  templateUrl: './javascriptdiffpage.page.html',
  styleUrls: ['./javascriptdiffpage.page.scss'],
})
export class JavascriptdiffpagePage implements OnInit {
